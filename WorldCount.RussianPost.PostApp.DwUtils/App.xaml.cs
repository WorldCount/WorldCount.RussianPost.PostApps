...
using WorldCount.RussianPost.PostApp.DwUtils.Services;
using WorldCount.RussianPost.PostApp.DwUtils.ViewModels;

namespace WorldCount.RussianPost.PostApp.DwUtils
{
